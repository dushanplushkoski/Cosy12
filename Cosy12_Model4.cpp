 ...
 */
 ...
 void Cosy12_Model4_step(void)
 {
   ...
   static const real_T b_2[5]{ 2.536, 3.2, 4.18, 4.887, 5.67 };
 
   static const int16_T c[4]{ 0, 1000, 2000, 2500 };
 
   static const int8_T b_3[4]{ 0, 25, 50, 85 };
   ...
   Cosy12_Model4_Y.OUTPUT4 = ((((((((((((((((((Cosy12_Model4_Y.OUTPUT10 * 0.0 -
     309.0) + Cosy12_Model4_U.Inport2 * 33.5) + Cosy12_Model4_U.Inport3 * 0.0) +
     C4 * -0.363) + C5 * 0.00187) + C6 * 0.00187) + rtb_MultiportSwitch1_f *
     0.227) + C8_tmp * -0.717) + C9_tmp * 4.63E-5) + C10 * 0.0) + C11 * -0.00562)
     + C12 * -2.98E-5) + C13 * 0.00248) + C14 * 0.0058) + C15 * 7.96E-5) + C16 *
     0.005) + C17 * 0.0) + C18 * -4.99E-7) + C19 * 0.0;
   Cosy12_Model4_Y.OUTPUT9 = ((((((((((((((((((Cosy12_Model4_Y.OUTPUT10 * -0.0517
     - 1.1) + Cosy12_Model4_U.Inport2 * 0.0) + Cosy12_Model4_U.Inport3 * 0.00558)
     + C4 * 0.0) + C5 * 0.000178) + C6 * -3.35E-5) + rtb_MultiportSwitch1_f * 0.0)
     + C8_tmp * 0.000962) + C9_tmp * 0.0) + C10 * -1.52E-7) + C11 * 0.0) + C12 *
     1.71E-6) + C13 * 4.29E-5) + C14 * 0.0) + C15 * 3.08E-7) + C16 * -1.33E-5) +
     C17 * -2.63E-9) + C18 * 0.0) + C19 * 0.0;
   Cosy12_Model4_Y.OUTPUT15 = ((((((((((((((((((Cosy12_Model4_Y.OUTPUT10 * -16.6
     + 213.0) + Cosy12_Model4_U.Inport2 * -43.5) + Cosy12_Model4_U.Inport3 * 2.09)
     + C4 * 0.0) + C5 * 0.0744) + C6 * -0.0196) + rtb_MultiportSwitch1_f * 1.03)
     + C8_tmp * 1.21) + C9_tmp * 0.0) + C10 * -0.00047) + C11 * -0.0199) + C12 *
     0.00056) + C13 * 0.0168) + C14 * 0.0) + C15 * 5.83E-5) + C16 * -0.00997) +
     C17 * -1.14E-6) + C18 * -2.33E-7) + C19 * 0.0;
   ...
   if (std::isnan(Cosy12_Model4_U.Inport2)) {
     ...
     if (Cosy12_Model4_U.Inport2 < 20.0) {
       ...
       C6 = 10.0 * static_cast<real_T>(low_i) + 20.0;
       C6 = (Cosy12_Model4_U.Inport2 - C6) / (((static_cast<real_T>(low_i) + 1.0)
         * 10.0 + 20.0) - C6);
       if (C6 == 0.0) {
         C4 = b[low_i];
       } else if (C6 == 1.0) {
   ...
   if (std::isnan(Cosy12_Model4_B.sf_CompressorSuctionMassgsRPM6.pressure)) {
     ...
     Cosy12_Model4_Y.OUTPUT12 =
       ...
       0.78300000000000036 * -200.0 + 1800.0;
     ...
     Cosy12_Model4_Y.OUTPUT12 =
       ...
       0.66400000000000015 * -200.0 + 2600.0;
   } else {
     high_i = 5;
     low_i = 1;
     low_ip1 = 2;
     while (high_i > low_ip1) {
       mid_i = (low_i + high_i) >> 1;
       if (Cosy12_Model4_B.sf_CompressorSuctionMassgsRPM6.pressure >= b_2[mid_i -
           1]) {
         low_i = mid_i;
         low_ip1 = mid_i + 1;
       } else {
     ...
     C6 = b_2[low_i - 1];
     C6 = (Cosy12_Model4_B.sf_CompressorSuctionMassgsRPM6.pressure - C6) /
       (b_2[low_i] - C6);
     if (C6 == 0.0) {
       Cosy12_Model4_Y.OUTPUT12 = (static_cast<real_T>(low_i) - 1.0) * -200.0 +
         2600.0;
     } else if (C6 == 1.0) {
       Cosy12_Model4_Y.OUTPUT12 = -200.0 * static_cast<real_T>(low_i) + 2600.0;
     } else {
       high_i = (low_i - 1) * -200 + 2600;
       low_i = -200 * low_i + 2600;
       if (high_i == low_i) {
         Cosy12_Model4_Y.OUTPUT12 = high_i;
       } else {
         Cosy12_Model4_Y.OUTPUT12 = (1.0 - C6) * static_cast<real_T>(high_i) + C6
           * static_cast<real_T>(low_i);
       }
     }
   }
   ...
   if (std::isnan(Cosy12_Model4_Y.OUTPUT12)) {
   ...
   } else if (Cosy12_Model4_Y.OUTPUT12 > 2500.0) {
     Cosy12_Model4_Y.OUTPUT5 = (Cosy12_Model4_Y.OUTPUT12 - 2500.0) / 500.0 * 35.0
       + 85.0;
   } else if (Cosy12_Model4_Y.OUTPUT12 < 0.0) {
     Cosy12_Model4_Y.OUTPUT5 = Cosy12_Model4_Y.OUTPUT12 / 1000.0 * 25.0;
   } else {
     high_i = 4;
     low_i = 0;
     low_ip1 = 2;
     while (high_i > low_ip1) {
       mid_i = ((low_i + high_i) + 1) >> 1;
       if (Cosy12_Model4_Y.OUTPUT12 >= c[mid_i - 1]) {
         low_i = mid_i - 1;
         low_ip1 = mid_i + 1;
       } else {
         high_i = mid_i;
     ...
     C6 = (Cosy12_Model4_Y.OUTPUT12 - static_cast<real_T>(c[low_i])) /
       static_cast<real_T>(c[low_i + 1] - c[low_i]);
     if (C6 == 0.0) {
    ...
    *  Gain: '<Root>/Gain3'
    */
   Cosy12_Model4_Y.OUTPUT2 = 0.00096 * C4;
